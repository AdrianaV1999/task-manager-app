...
const Profile = ({ setCurrentUser, onLogout }) => {
  ...
  const saveProfile = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || "Profile data not updated!");
    }
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <button onClick={() => navigate(-1)} className={BACK_BUTTON}>
          <ChevronLeft className="w-5 h-5 mr-1"></ChevronLeft>Back To Dashboard
        </button>
        <div className="flex items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-500 to-sky-600 flex items-center justify-center text-white text-2xl font-bold shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-7">
          <section className={SECTION_WRAPPER}>
            <div className="flex items-center gap-2 mb-6">
              <UserCircle className="text-sky-500 w-5 h-5"></UserCircle>
          ...
          <section className={SECTION_WRAPPER}>
            <div className="flex items-center gap-2 mb-6">
              <Shield className="text-sky-500 w-5 h-5"></Shield>
              <h2 className="text-xl font-semibold text-gray-800">
            ...
            <form onSubmit={changePassword} className="space-y-4">
              ...
              <div className="mt-8 pt-6 border-t border-sky-100">
                <h3 className="text-sky-600 font-semibold mb-4 flex items-center gap-2">
                  <LogOut className="w-4 h-4"></LogOut>Danger Zone
                </h3>
